...
/**
 * HR of One - Dynamic Agent Orchestrator
 * 
 * Template for creating orchestrators for other "Of One" sites.
 * Replace HR of One, Small business owners and solo HR managers, and customize TASK_REGISTRY.
 */
...
const SITE_CONFIG = {
  name: 'HR of One',  // e.g., 'Director of One'
  domain: 'hrofone.ai',   // e.g., 'directorofone.ai'
  targetAudience: 'Small business owners and solo HR managers', // e.g., 'one-person department managers'
  primaryColor: '#4169E1',  // Utlyze blue (keep consistent)
  accentColor: '#3498DB',  // Customize per site type
};
...
const TASK_REGISTRY = {
  ...
  'content-strategy': {
    ...
    estimatedHours: 4,
    priority: 'CRITICAL',
    prompt: `Create content for ${SITE_CONFIG.name}. Target: ${SITE_CONFIG.targetAudience}. Pain points: Keeping up with hiring paperwork and benefits, Worried about missing compliance requirements, Onboarding gets rushed or messy, Endless employee questions and requests. Solution: Full HR toolkit with automation for routine tasks and compliance. Focus on Automated payroll and benefits, Compliance tracking and alerts, Onboarding workflow automation, Employee self-service portal.`,
